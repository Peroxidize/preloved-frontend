      ...
      <div className={css.container}>
        <div className={css.ticket_pending}>
          <div className={css.space_between}>
            <p className={css.pending_button}>
              Waiting for confirmation
            </p>
            <p className={css.ticket_number}>
              #301126
            </p>
          </div>
          <hr className={css.hr}/>
          <div className={css.pending_info}>
            <div className={css.space_between}>
              <p className={css.item_name}>
                Dotted White Cardigan
              </p>
              <p className={css.price_tag}>
                ₱215.00
              </p>
            </div>
